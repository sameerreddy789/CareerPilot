...
function generateSidebar() {
    ...
    const sidebarHTML = `
        ...
        <div class="sidebar-footer">
            <button id="theme-toggle-btn" class="theme-toggle-btn sidebar-theme-btn" aria-label="Toggle theme" title="Toggle dark/light mode" onclick="if(window.ThemeToggle) window.ThemeToggle.toggle()">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Update theme toggle icon if ThemeToggle is loaded
    ...
    appState.subscribe(() => {
        ...
        // Re-update theme icon after sidebar re-render
        if (window.ThemeToggle) {
            window.ThemeToggle.updateToggleIcon(window.ThemeToggle.getPreferred());
        }
    });
